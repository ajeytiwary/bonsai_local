...
TOOL_SCHEMAS=[
 ...
 {"type":"function","function":{"name":"read_range","description":"Read a 1-based inclusive line range of a file (prints line numbers). Use before editing large files.","parameters":{"type":"object","properties":{"path":{"type":"string"},"start_line":{"type":"integer"},"end_line":{"type":"integer"},"context":{"type":"integer"}},"required":["path","start_line"]}}},
 {"type":"function","function":{"name":"write_file","description":"Explicit full replacement of a file with complete content. Prefer replace_in_file/apply_patch for localized changes; use this only for intentional full rewrites.","parameters":{"type":"object","properties":{"path":{"type":"string"},"content":{"type":"string"}},"required":["path","content"]}}},
 {"type":"function","function":{"name":"replace_in_file","description":"Exact localized replacement. old must match exactly once unless occurrence (1-based) is given; ambiguity or no-match fails with a report.","parameters":{"type":"object","properties":{"path":{"type":"string"},"old":{"type":"string"},"new":{"type":"string"},"occurrence":{"type":"integer"}},"required":["path","old","new"]}}},
 {"type":"function","function":{"name":"apply_patch","description":"Apply a unified diff (--- a/ +++ b/ @@ hunks) to one or more workspace files. Context lines must match exactly; failures report the mismatching line.","parameters":{"type":"object","properties":{"patch":{"type":"string"},"path":{"type":"string"}},"required":["patch"]}}},
 {"type":"function","function":{"name":"create_file","description":"Create a new file (fails if it already exists) with full content.","parameters":{"type":"object","properties":{"path":{"type":"string"},"content":{"type":"string"}},"required":["path","content"]}}},
