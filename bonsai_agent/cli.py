...
def main():
    ...
    if a.index_stats or a.index_search:
        ...
        return
    agent=Agent(Path(a.repo),BonsaiLLM(a.url,a.model),a.tests,a.max_steps,a.compact_every,a.max_repairs,a.retrieve_top_k,a.unsafe_shell,not a.no_auto_commit,a.verify_tests_only,a.worker_output_tokens)
